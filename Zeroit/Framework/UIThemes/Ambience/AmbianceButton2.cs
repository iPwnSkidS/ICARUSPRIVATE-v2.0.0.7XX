    ...
    public class AmbianceButton2 : Control
    {
        ...
        protected override void OnResize(EventArgs e)
        {
            if (base.Width > 0 && base.Height > 0)
            {
                ...
                InactiveGB = new LinearGradientBrush(new Rectangle(0, 0, base.Width, base.Height), Color.FromArgb(253, 175, 143), Color.FromArgb(244, 146, 106), 90f);
                PressedGB = new LinearGradientBrush(new Rectangle(0, 0, base.Width, base.Height), Color.FromArgb(244, 146, 106), Color.FromArgb(244, 146, 106), 90f);
                PressedContourGB = new LinearGradientBrush(new Rectangle(0, 0, base.Width, base.Height), Color.FromArgb(162, 120, 101), Color.FromArgb(162, 120, 101), 90f);
